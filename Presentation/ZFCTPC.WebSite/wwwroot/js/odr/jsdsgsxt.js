...
document.write('<a href="' + webprefix + "entweb/elec/certView.shtml?siteId=6c8c12f9e6014352b29a295dcaab5d02" + '" target="_blank"><img src="' + tempiconImageURL + '" title="" alt="" width="' + params.width + '" height="' + params.height + '"border="0" style="border-width:0px;border:hidden; border:none;"/></a>');
